...
void Experiencia::agregarTurista(Turista* tur){ this->turistas.push_back(tur); }//agrega el turista
void Experiencia::borrarTurista(Turista* tur){ this->turistas.remove(tur); }//borra el turista
